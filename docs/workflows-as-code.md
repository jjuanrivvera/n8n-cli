...
The last two are **node-schema-aware**: they validate against a catalog of n8n's
...
typo'd node types (with a "did you mean …?" suggestion) and parameters a node does
