---
title: n8nctl data-tables delete-rows
---

## n8nctl data-tables delete-rows

Delete rows matching a filter

```
n8nctl data-tables delete-rows <tableId> --filter <json> [flags]
```

### Options

```
      --filter string   filter as a JSON string (required)
  -h, --help            help for delete-rows
```
