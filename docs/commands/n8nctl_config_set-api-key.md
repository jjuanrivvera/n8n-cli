---
title: n8nctl config set-api-key
---

## n8nctl config set-api-key

Store an API key in the keyring for the active profile (no verification)

```
n8nctl config set-api-key <key> [flags]
```
