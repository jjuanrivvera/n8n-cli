---
title: n8nctl packages export
---

## n8nctl packages export

Export workflows as a .n8np package

```
n8nctl packages export --workflow <id> [--workflow <id> ...] --out <file.n8np> [flags]
```
...
```
  -h, --help                   help for export
      --out string             output .n8np file (required)
      --workflow stringArray   workflow id to export (repeatable)
```
