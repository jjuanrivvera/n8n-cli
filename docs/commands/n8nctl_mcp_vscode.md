...
* [n8nctl mcp vscode disable](n8nctl_mcp_vscode_disable.md)	 - Remove server from VSCode config
* [n8nctl mcp vscode enable](n8nctl_mcp_vscode_enable.md)	 - Add server to VSCode config
* [n8nctl mcp vscode list](n8nctl_mcp_vscode_list.md)	 - Show VSCode MCP servers
