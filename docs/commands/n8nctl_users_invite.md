...
```
n8nctl users invite --email <addr> [--email <addr> ...] [--role <role>] [flags]
```

### Options

```
      --email stringArray   email to invite (repeatable)
  -h, --help                help for invite
      --role string         global role: global:admin|global:member (default member)
```
