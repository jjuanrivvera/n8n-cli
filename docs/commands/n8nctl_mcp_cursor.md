...
* [n8nctl mcp cursor disable](n8nctl_mcp_cursor_disable.md)	 - Remove server from Cursor config
* [n8nctl mcp cursor enable](n8nctl_mcp_cursor_enable.md)	 - Add server to Cursor config
* [n8nctl mcp cursor list](n8nctl_mcp_cursor_list.md)	 - Show Cursor MCP servers
