---
title: n8nctl projects set-member-role
---

## n8nctl projects set-member-role

Change a project member's role

```
n8nctl projects set-member-role <projectId> <userId> --role <role> [flags]
```

### Options

```
  -h, --help          help for set-member-role
      --role string   new project role (required)
```
