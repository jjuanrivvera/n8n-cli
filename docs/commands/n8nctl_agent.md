...
Helpers for running n8nctl under an AI agent

### Synopsis

Helpers for running n8nctl under an AI agent (Claude Code, Codex, OpenCode, …).
...
* [n8nctl agent guard](n8nctl_agent_guard.md)	 - Generate agent-safety config that blocks destructive n8n operations
